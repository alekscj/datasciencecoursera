...
data_1999 <- data.frame(baltimore_by_year[[1]])
data_2002 <- data.frame(baltimore_by_year[[2]])
data_2005 <- data.frame(baltimore_by_year[[3]])
data_2008 <- data.frame(baltimore_by_year[[4]])
